...
As is mentioned above, the Note provides non-ambigous definitions for 10 core information items. It also provides 8 detailed best practice recommendations related to the 10 core information items. The core information items are mentioned below. The interested can view the Note online.<sup>[7](#references)</sup>
