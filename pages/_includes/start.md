...
## <span style="color:silver"> 2.6.0 </span> Process 
...
# <span style="color:silver"> 3.0.0 </span> Basic

## <span style="color:silver"> 3.1.0 </span> Summary of Operations
{:.no_toc}
The CDS Discovery is the initial process that occurs...

### <span style="color:silver"> 3.1.1 </span> Medication Prescribe Service
{:.no_toc}
<figure class="figure">
...
## <span style="color:silver"> 3.2.0 </span> CDS Discovery
{:.no_toc}
...
### <span style="color:silver"> 3.2.1 </span> Example 1: EHR Request for CDS Discovery
{:.no_toc}
````
...
## <span style="color:silver"> 3.4.0 </span> Clinical Reasoning
{:.no_toc}
...
### <span style="color:silver"> 3.4.1 </span> PlanDefinition
{:.no_toc}
...
## <span style="color:silver"> 3.6.0 </span> PDDI CDS CQL Library
{:.no_toc}
...
# <span style="color:silver"> 4.0.0 </span> Advanced
