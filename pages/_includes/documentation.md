...
Figure 1 progresses through the decision tree and indicates warnings contextual and factors that are passed to the EHR to display to the clinician.
...
# <span style="color:silver"> 8.0.0 </span> Digoxin + Cyclosporin
